                  ...
                  <div className="tp-footer-widget footer-col-4-1 mb-50">
                    ...
                    <div className="tp-footer-widget-content">
                      <div className="tp-footer-talk mb-20">
                        ...
                        <h4><a href="tel:254-713-905-761">+254 713 905 761</a></h4>
                      </div>
                      <div className="tp-footer-contact">
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><a href="mailto:shofy@support.com">sheebacosmetics@gmail.com</a></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          <div className="tp-footer-contact-icon">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><a href="https://www.google.com/maps/place/Sleepy+Hollow+Rd,+Gouverneur,+NY+13642,+USA/@44.3304966,-75.4552367,17z/data=!3m1!4b1!4m6!3m5!1s0x4cccddac8972c5eb:0x56286024afff537a!8m2!3d44.3304928!4d-75.453048!16s%2Fg%2F1tdsjdj4" target="_blank">CBD. <br /> Kenya, Nairobi 1432</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="row align-items-center">
                  <div className="col-md-6">
                    <div className="tp-footer-copyright">
                      <p>© {new Date().getFullYear()} All Rights Reserved  |  SHEEBA COSMETICS
<Question ID="1" Shortcut="chapter 1" Order="" ElementType="chapter" >
<LongCaption><Link href="/">ThemePure</Link>.</LongCaption>
</Question>
                      </p>
                    </div>
                  </div>
